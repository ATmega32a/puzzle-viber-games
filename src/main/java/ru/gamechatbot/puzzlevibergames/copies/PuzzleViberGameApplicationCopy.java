//package ru.gamechatbot.puzzlevibergames.copies;
//
...
//import ru.gamechatbot.puzzlevibergames.PuzzleViberGamesApplication;
...
//
//public class PuzzleViberGameApplicationCopy {
//
...
//
////    @Autowired
////    public void setGameStatesService(GameStatesService gameStatesService) {
...
////
////                    System.out.println("gameStatesService.findFirstByOwner(viberId).get() = " + gameStatesService.findFirstByOwner(viberId));
////                    Optional<List<String>> array = Optional.of(gameStatesService.findFirstByOwner(viberId).get().getTagGame().getArray());
////                            System.out.println("array = " + array.get());
////                    Optional<List<String>> colors = Optional.of(gameStatesService.findFirstByOwner(viberId).get().getTagGame().getColors());
////                            System.out.println("colors = " + colors.get());
////                    System.out.println("array.get() = " + array.get());
////                    System.out.println("color.get() = " + colors.get());
//
...
////            storage.getStorage().put(viberId, ticTacToe);
////            gameStates.setOwner(viberId);
////            gameStates.setTicTacToe(ticTacToe);
////            gameStatesService.saveStateGame(gameStates);
...
//            String viberId = event.getSender().getId();
////            TagGame tagGame = (TagGame) game(TagGame.class);
////            storage.getStorage().put(viberId, tagGame);
////            GameStates gameStates = new GameStates(viberId, tagGame);
//            gameStates.setOwner(viberId);//
//            gameStatesService.saveStateGame(gameStates);
//            gameService.save(tagGame);
